      ...
      <div class="mod-config">
        <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
          ...
          <el-form-item>
            ...
            <el-button @click="getAllDataList()" type="success">查询全部</el-button>
            <el-button
        ...
        >
          ...
          >
            <template slot-scope="scope">
              <el-button @click="relationHandle(scope.row.attrGroupId)" size="small" type="text">关联</el-button>
              <el-button
              ...
              <el-button @click="deleteHandle(scope.row.attrGroupId)" size="small" type="text">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-pagination
