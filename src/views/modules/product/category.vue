<template>
  <div>
    <el-switch active-text="开启拖拽" inactive-text="关闭拖拽" v-model="draggable"></el-switch>
    ...
    >
      <el-form :model="category">
        ...
        <el-form-item label="计量单位">
          <el-input autocomplete="off" v-model="category.productUnit"></el-input>
        </el-form-item>
      </el-form>
      <span class="dialog-footer" slot="footer">
        <el-button @click="dialogVisible = false">取 消</el-button>
        <el-button @click="submitData" type="primary">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
